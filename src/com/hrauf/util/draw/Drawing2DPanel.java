 ...
 * @author Hammad
 */
public class Drawing2DPanel extends javax.swing.JPanel {

    private java.awt.BorderLayout myLayout = null;
    private javax.swing.JPanel outerScribblePanel = null;
    private javax.swing.JPanel testPanel = null;
  ...
  //hmr   @Override
    public void init() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Drawing2DPanel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//debug
        outerScribblePanel = new javax.swing.JPanel();
        outerScribblePanel.setLayout(new java.awt.BorderLayout());
        testPanel = new javax.swing.JPanel();
        testPanel.setBackground(Color.green);
        testButton = new javax.swing.JButton("Test Button"); 
        testButton.setSize(20, 10);
        ...
        this.add(jpanellToolbars, java.awt.BorderLayout.NORTH);
...
*/
        outerScribblePanel.add(scribblePanel1, java.awt.BorderLayout.CENTER);
//debug        this.add(outerScribblePanel, java.awt.BorderLayout.CENTER);
        
        testPanel.add(testButton, java.awt.BorderLayout.CENTER);
        this.add(testPanel, java.awt.BorderLayout.CENTER);
        
        
        jpanelMessage.setName("jpanelMessage"); // NOI18N
        jpanelMessage.setPreferredSize(new java.awt.Dimension(this.getWidth(), 26));
        jpanelMessage.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT));

        jtxtMessage.setEditable(false);
        jtxtMessage.setFont(new java.awt.Font("Tahoma", 0, 8));
        ...
        jtxtMessage.setPreferredSize(new java.awt.Dimension(this.getWidth()-40, 20));
        jpanelMessage.add(jtxtMessage);

        this.add(jpanelMessage, java.awt.BorderLayout.SOUTH);
    }

private void testButtonActionPerformed(java.awt.event.ActionEvent evt) {
    jtxtMessage.setText("Test Button Pressed");
}
...
//Web ====>        connectAppletURL = new URL(getCodeBase().toString()+"ServletConnectApplet2.strut");
...
// Web====>            this.jtxtMessage.setText("STRING: "+ decodedString+"-"+getCodeBase().toString() + "ServletConnectApplet2.strut");
        }
        in.close();
	//	System.out.println("InputStream Closed");

        } catch (Exception ex) {
              Logger.getLogger(Drawing2DPanel.class.getName()).log(Level.SEVERE, null, ex);          
        } finally {
            // objOut = null;
        }
...
public void setPNGBytesArray(byte[] pngBytes) throws Exception {
        scribblePanel1.setPNGBytesArray(pngBytes);
}
    
public byte[] getPNGBytesArray() {
        return scribblePanel1.getPNGBytesArray();
}

    private void fixPanelSizes() {
        jtbBlack.setSize(20, 15); jtbRed.setSize(20, 15);
        jtbBlue.setSize(20, 15); jtbGreen.setSize(20, 15);
        jpanellToolbars.setSize(this.getWidth(), 70);
        jtxtMessage.setSize(this.getWidth()-20, 20);
        jpanelMessage.setSize(this.getWidth(), 26);
        scribblePanel1.setSize(this.getWidth(), this.getHeight()-96);
        scribblePanel1.setPreferredSize(new Dimension(this.getWidth(), this.getHeight()-96));
        outerScribblePanel.setSize(this.getWidth(), this.getHeight()-96);
//debug        
        testPanel.setSize(this.getWidth(), this.getHeight()-96);
    }

    public Drawing2DPanel() {
        super();
        myLayout = new java.awt.BorderLayout();
